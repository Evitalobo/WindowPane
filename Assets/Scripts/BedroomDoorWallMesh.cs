 ...
 public class BedroomDoorWallMesh : MonoBehaviour {    
	
	public Material material;
	public Vector3[] vertices = {
     new Vector3(-20.0f, 25.0f, 0.0f), new Vector3(20.0f, 25.0f, 0.0f), 
     new Vector3(20.0f, 0.0f, 0.0f), new Vector3(-20.0f, 0.0f, 0.0f),
     new Vector3(-13.1f, 18.0f, 0.0f), new Vector3(-4.9f, 18.0f, 0.0f), 
     new Vector3(-4.9f, 0.0f, 0.0f), new Vector3(-13.1f, 0.0f, 0.0f),
     new Vector3(-13.1f, 18.0f, 0.0f), new Vector3(-4.9f, 18.0f, 0.0f), 
     new Vector3(-4.9f, 0.0f, 0.0f), new Vector3(-13.1f, 0.0f, 0.0f),
     new Vector3(-13.1f, 18.0f, 0.1f), new Vector3(-4.9f, 18.0f, 0.1f), 
     new Vector3(-4.9f, 0.0f, 0.1f), new Vector3(-13.1f, 0.0f, 0.1f),
     new Vector3(-13.1f, 18.0f, 0.1f), new Vector3(-4.9f, 18.0f, 0.1f), 
     new Vector3(-4.9f, 0.0f, 0.1f), new Vector3(-13.1f, 0.0f, 0.1f)
 	};
