...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        private Item m_CurrentInteractible;                //The current interactive item
        private Item m_LastInteractible;                   //The last interactive item


        // Utility for other classes to get the current interactive item
        public Item CurrentInteractible
        {
        ...
        private void EyeRaycast()
        {
            ...
            {
                Item interactible = hit.collider.GetComponent<Item>(); //attempt to get the VRInteractiveItem on the hit object
                if (interactible == null)
                {
                    interactible = hit.collider.GetComponentInParent<Item>();
                }
